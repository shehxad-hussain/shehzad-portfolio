     ...
     <div className='container mx-auto p-5 '>
        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          ...
          <div data-aos="fade-right"  data-aos-duration="1400" className='flex-1 text-center lg:text-start font-secondary'>
            <h1 className='text-3xl font-bold leading-[0.8] lg:text-5xl '>Shehzad <span>Hussain </span></h1>
          ...
          <p className='mb-12 max-w-lg mx-auto lg:mx-0'>"Experienced frontend developer skilled in crafting 
          engaging and user-friendly web experiences. Proficient in Javascript,Typescript and React Js 
          to create seamless interfaces.</p>
          ...
          <a href="#contact">
            <button className='btn btn-lg '>Work With Me</button>
                ...
                <a href="https://react-portfolio-seven-pink.vercel.app/" className='text-gradient btn-link text-2xl'>My portfolio</a>
